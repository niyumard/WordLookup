...
path = "/Users/yu/Documents/english study/mdx/LDOCE6双解/L6mp3.mdx"


@register("本地词典-LDOCE6")
class Ldoce6(MdxService):
    ...
    @export("all sentence", 7)
    def fld_allsentence(self):
        html = self.get_html()
        m = re.findall(
            r'(<span class="example">.+?</span example><span class="example_c">.+?</span example_c>)',
            html,
        )
        if m:
            items = 0
